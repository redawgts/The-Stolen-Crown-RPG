...
def create_game_data_dict():
    ...
    player_items = {
        "GOLD": {"quantity": 100, "value": 0},
        "Healing Potion": {"quantity": 2, "value": 15},
        "Ether Potion": {"quantity": 1, "value": 15},
        "Rapier": {"quantity": 1, "value": 50, "power": 9},
    ...
    data_dict = {
        ...
        "last direction": "down",
        "king item": "GOLD",
        "old man item": {"ELIXIR": {"value": 1000, "quantity": 1}},
