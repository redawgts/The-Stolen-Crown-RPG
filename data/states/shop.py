...
class Inn(Shop):
    ...
    def make_purchasable_items(self):
        ...
        item = {"type": "room", "price": 30, "quantity": 0, "power": None, "dialogue": dialogue}
...
class WeaponShop(Shop):
    ...
    def make_dialogue(self):
        ...
        return ["Welcome to the " + shop_name + "!", "What weapon would you like to buy?"]
...
class ArmorShop(Shop):
    ...
    def make_dialogue(self):
        """Make the list of dialogue phrases"""
        shop_name = "{}{}".format(self.name[0].upper(), self.name[1:])
        return ["Welcome to the " + shop_name + "!", "Would piece of armor would you like to buy?"]
...
class MagicShop(Shop):
    ...
    def make_dialogue(self):
        """Make the list of dialogue phrases"""
        shop_name = "{}{}".format(self.name[0].upper(), self.name[1:])
        return ["Welcome to the " + shop_name + "!", "Would magic spell would you like to buy?"]
...
class PotionShop(Shop):
    ...
    def make_dialogue(self):
        """Make the list of dialogue phrases"""
        shop_name = "{}{}".format(self.name[0].upper(), self.name[1:])
        return ["Welcome to the " + shop_name + "!", "What potion would you like to buy?"]
