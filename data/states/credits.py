...
class CreditEntry:
    ...
    def make_credits(self):
        ...
        """
        credits = [
            ["THE STOLEN CROWN", "A Fantasy RPG"],
            ...
            ["SOUND EFFECTS", "Kenney", "Nic3_one", "Ekokubza123", "kuzyaburst", "audione"],
            ["SPECIAL THANKS", "/r/pygame", "Leif Theden", "Stacey Hunniford"],
        ]
        ...
        for credit in credits:
            ...
            for i, subcredit in enumerate(credit):
                ...
                text_sprite.rect = text_sprite.text_image.get_rect(centerx=400, y=100 + (i * 40))
